...
class PhonesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // GridView bilan ishlash
        val grid = findViewById<GridView>(R.id.gridBrands)
        val adapter = ArrayAdapter(this, R.layout.item_brand, R.id.brandName, brands)
        grid.adapter = adapter

        grid.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            val intent = Intent(this, PhonesVersion::class.java)
